...
## Claude Code skill (generate diagrams into Transilience Ideate)

Agents can emit Transilience Ideate `GeneratedGraph` JSON and open it with a `?g=` URL.
The skill is hosted with the app:

- Skill file: https://transilience-ideate.vercel.app/skills/transilience-ideate/SKILL.md
...
Then restart Claude Code and ask for a Transilience Ideate diagram. The agent builds
`https://transilience-ideate.vercel.app/?g=<uri-encoded-json>` and opens it.
