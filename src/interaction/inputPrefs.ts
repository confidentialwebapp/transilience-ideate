...
const WHEEL_ZOOM_KEY = "transilience-ideate:wheel-zoom";
const INVERT_PITCH_KEY = "transilience-ideate:invert-pitch";
const RIGHT_DRAG_PAN_KEY = "transilience-ideate:right-drag-pan";
const ZOOM_SENSITIVITY_KEY = "transilience-ideate:zoom-sensitivity";
const ZOOM_OUT_LIMIT_KEY = "transilience-ideate:zoom-out-limit";
const ZOOM_IN_LIMIT_KEY = "transilience-ideate:zoom-in-limit";
