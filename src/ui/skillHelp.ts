...
export const SKILL_URL = "https://transilience-ideate.vercel.app/skills/transilience-ideate/SKILL.md";
...
/**
 * Informational modal for the Transilience Ideate skill URL. Opened from the topbar;
    ...
    const card = h(
      ...
      h(
        ...
        h(
          "p",
          null,
          "Copy this link and drop it into your AI harness so it can generate Transilience Ideate diagrams for you.",
        ),
        h(
          "div",
